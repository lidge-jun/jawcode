...
- ✅ `AGENTS.md`, `README*.md`, `structure/` 문서는 jwc 기준 정본으로 유지한다. upstream jawcode 기준 문구는 `devlog/_upstream_gjc/`·`struct_har/gjc_origin/` 같은 비교/근거 문맥에만 남긴다
...
- upstream lineage는 worktree remote가 아니라 `devlog/_upstream_gjc/` 참조 클론에서 대조한다.
...
| remote | `https://github.com/Yeachan-Heo/jawcode` |
...
```bash
git clone https://github.com/Yeachan-Heo/jawcode devlog/_upstream_gjc
```
...
HEAD | `d60b7822` (`dev`) | `git -C /Users/jun/Developer/new/700_projects/jawcode rev-parse --short HEAD` (2026-06-14)
origin fetch/push | `https://github.com/lidge-jun/jawcode` (`origin/dev` tracks `d60b7822`) | `git -C /Users/jun/Developer/new/700_projects/jawcode remote -v` · `git -C /Users/jun/Developer/new/700_projects/jawcode branch -vv` (2026-06-14)
upstream baseline (참조 클론) | `https://github.com/Yeachan-Heo/jawcode` @ `devlog/_upstream_gjc/` | §2.2 · `git -C devlog/_upstream_gjc rev-parse --short HEAD`
worktree branch | `dev` @ `d60b7822` | `git -C /Users/jun/Developer/new/700_projects/jawcode branch -vv`
upstream 참조 클론 HEAD | `269387ba` | `git -C devlog/_upstream_gjc rev-parse --short HEAD` (2026-06-14)
...
| remote | `https://github.com/Yeachan-Heo/jawcode` | upstream remote와 동일 |
클론 HEAD (기록 시점) | `269387ba` | `git -C devlog/_upstream_gjc rev-parse --short HEAD` (2026-06-14)
...
grep -n deep-interview devlog/_upstream_gjc/packages/coding-agent/src/defaults/<legacy-defaults-file>.ts
```
