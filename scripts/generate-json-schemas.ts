...
import { zodToWireSchema } from "@jawcode-dev/ai/utils/schema/wire";
...
function settingDefinitionToJsonSchema(settingPath: string, definition: SettingDefinition): JsonSchemaObject {
	...
	if (settingPath === "jwc.interview.ambiguityThreshold" || settingPath === "gjc.deepInterview.ambiguityThreshold") {
