...
import { listCommandRefBlocks, renderCommandRefBlock } from "../packages/coding-agent/src/jwc-runtime/workflow-command-ref";
...
function usage(): never {
	console.error("Usage: bun scripts/generate-jwc-skill-command-refs.ts [--check] [--strict] [--json]");
	process.exit(2);
}
