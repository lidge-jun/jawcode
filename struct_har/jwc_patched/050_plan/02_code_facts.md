...
diff -u devlog/_upstream_gjc/packages/coding-agent/src/defaults/jwc/skills/plan/SKILL.md packages/coding-agent/src/defaults/jwc/skills/plan/SKILL.md | head
```
