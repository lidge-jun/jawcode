...
diff -u devlog/_gjc_chase/gajae-code/packages/coding-agent/src/defaults/jwc/skills/jaw-interview/SKILL.md packages/coding-agent/src/defaults/jwc/skills/jaw-interview/SKILL.md | head
```
