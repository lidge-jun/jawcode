...
diff -u devlog/_gjc_chase/gajae-code/packages/coding-agent/src/defaults/gjc/skills/ralplan/SKILL.md packages/coding-agent/src/defaults/gjc/skills/ralplan/SKILL.md | head
```
