...
diff -u devlog/_gjc_chase/gajae-code/packages/coding-agent/src/defaults/gjc/skills/ultragoal/SKILL.md packages/coding-agent/src/defaults/gjc/skills/ultragoal/SKILL.md | head
```
