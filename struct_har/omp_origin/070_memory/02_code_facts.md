# 070_memory — 02 code facts (omp_origin)
...
| # | path | status |
|---:|---|---|
| 1 | `packages/mnemopi` | present |
| 2 | `packages/coding-agent/src/memories` | present |

## diff (예)

```bash
diff -u devlog/_omp_chase/oh-my-pi/packages/mnemopi devlog/_gjc_chase/gajae-code/packages/mnemopi | head
```
