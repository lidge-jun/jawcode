...
> **repo 기준**: `devlog/_omp_chase/oh-my-pi/` 클론 (gitignored).
> 절대 cite: `/Users/jun/Developer/new/700_projects/jawcode/devlog/_omp_chase/oh-my-pi/<path>:<line>`
...
gjc upstream (`devlog/_gjc_chase/gajae-code`): `packages/ai/src/models.json` + generate-models 스크립트 — **단일 ai 패키지**.
...
1. `git -C devlog/_omp_chase/oh-my-pi fetch origin`
2. `git -C devlog/_omp_chase/oh-my-pi log -1 --oneline` → 본 파일 상단·`README.md`에 기록
