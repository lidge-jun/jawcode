# 083_output — 02 code facts (omp_origin)
...
| # | path | status |
|---:|---|---|
| 1 | `packages/coding-agent/src/modes/components` | present |

## diff (예)

```bash
diff -u devlog/_omp_chase/oh-my-pi/packages/coding-agent/src/modes/components devlog/_gjc_chase/gajae-code/packages/coding-agent/src/modes/components | head
```
