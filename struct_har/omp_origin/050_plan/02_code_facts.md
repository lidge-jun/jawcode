# 050_plan — 02 code facts (omp_origin)
...
| # | path | status |
|---:|---|---|
| 1 | `packages/coding-agent/src/commands` | present |
| 2 | `docs/slash-command.md` | missing (verify clone) |

## diff (예)

```bash
diff -u devlog/_omp_chase/oh-my-pi/packages/coding-agent/src/commands devlog/_gjc_chase/gajae-code/packages/coding-agent/src/commands | head
```
