...
- [ ] Tests: tagged leader · verified real tmux leader self-heal · foreign/unmanaged reject.
...
| Decision F — residual risk | Monitored until implementation proves self-heal cannot retag a foreign tmux session. |
