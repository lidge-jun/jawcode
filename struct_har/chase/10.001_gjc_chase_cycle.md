...
| [10.061](./10.061_gjc_chase_tmux_team_windows_psmux_titles.md) | `beec1af0`, `1d65050d` | tmux workspace titles + Windows/psmux team spawn reliability (#1303 follow-up to #1282) |
...
| [10.041](./_fin/10/10.041_gjc_chase_tui_input_render_windows_psmux.md) TUI input/render Windows psmux | ✅ _fin 260701 | `38ac6dcd` adapted: main editor autocomplete provider now reaches HookSelector inline/docked/list-slot custom inputs; 48 focused pass + `check:ts` + verifier PASS; Windows/psmux split remains 10.057/10.061/10.050 |
| [10.057](./_fin/10/10.057_gjc_chase_windows_hardening.md) Windows hardening | ✅ _fin 260701 | npm shim detection + package-manager verification + backup cleanup tolerance; Windows-safe team worker command; worktree/coordinator real error preservation; 106 focused pass + `check:ts`; full psmux/titles deferred |
