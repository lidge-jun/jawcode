...
> **정본 클론**: `devlog/_omp_chase/oh-my-pi/` · branch `main` tracking `origin/main` · reviewed through `0fc6d136`
...
> Document: `struct_har/chase/004_reference_from_omp.md`
> Title: chase — omp 참조 방안
> Lane: OMP
...
1. Start from this document, then open the current source lane at `devlog/_omp_chase/oh-my-pi` and the matching JWC files under packages/coding-agent/.
