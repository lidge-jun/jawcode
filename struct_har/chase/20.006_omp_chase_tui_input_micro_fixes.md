...
- [ ] Esc 드래프트 클리어 + selector `resetDisplay` 동등물 적용 또는 JWC TUI API 부재에 따른 명시적 defer (jaw IME/입력 패치와 충돌 확인 — 082 밴드).
- [ ] ast-edit status line 공백 축약 적용 및 focused test 추가.
...
| Decision F — residual risk | Monitored until JWC 99.20 input/IME behavior is proven not to regress. |
