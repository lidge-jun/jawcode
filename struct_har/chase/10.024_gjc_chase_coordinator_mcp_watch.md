...
- [ ] Product decision recorded in this chase card.
- [ ] If implementing a subset: tests from `coordinator-mcp-server.test.ts` plus JWC harness/RPC observation subset green.
