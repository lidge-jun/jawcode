...
jawcode를 **OSS upstream**으로 운영할 때도 chase는 유효하다: gjc/omp는 **계보·벤치마크**, jwc SoT는 `structure/` + worktree @ `5c375b1` (2026-07-02 chase refresh).
...
> Document: `struct_har/chase/001_overview.md`
> Title: chase — 개요
