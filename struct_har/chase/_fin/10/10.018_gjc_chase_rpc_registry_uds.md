...
> Document: `struct_har/chase/_fin/10/10.018_gjc_chase_rpc_registry_uds.md`
> Title: 10.018 — gjc chase: RPC session registry + persistent UDS server
> Lane: GJC
...
1. Start from this document, then open the current source lane at `devlog/_gjc_chase/gajae-code` and the matching JWC files under packages/coding-agent/, packages/agent/, python/jwc-rpc/.
