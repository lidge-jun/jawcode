...
> Document: `struct_har/chase/_fin/10/10.013_gjc_chase_perf_compaction.md`
> Title: 10.013 — gjc chase: perf(compaction) — token estimation 캐시 (#557)
> Lane: GJC+OMP
...
1. Start from this document, then open the current source lane at `devlog/_gjc_chase/gajae-code + devlog/_omp_chase/oh-my-pi` and the matching JWC files under packages/coding-agent/, packages/utils/.
