...
| TUI/input/psmux | selector inline/list-slot autocomplete and Windows hardening closed; full Windows psmux/team titles remain separate | 중 — UX/runtime | [10.041](./_fin/10/10.041_gjc_chase_tui_input_render_windows_psmux.md) ✅ _fin · [10.057](./_fin/10/10.057_gjc_chase_windows_hardening.md) ✅ _fin · [10.061](./10.061_gjc_chase_tmux_team_windows_psmux_titles.md) |
