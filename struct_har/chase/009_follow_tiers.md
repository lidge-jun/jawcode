...
| [10.062](./10.062_gjc_chase_ai_provider_deepinfra_gemini_ua.md) | DeepInfra + Gemini UA | IMPORT · models.json additive merge |
| [10.054](./10.054_gjc_chase_local_provider_discovery.md) | local provider discovery | IMPORT |
