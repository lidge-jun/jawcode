# Evidence: JWC config/youtube patch verification rerun 2
...
PASS: Both requested Bun build probes exited 0 on this fresh rerun. Output is limited to the first three emitted lines by the requested head -3 pipeline.
