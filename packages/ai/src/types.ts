 ...
 * providers, `"auto"`, and scope mismatches all return false. `"default"`
 * is deliberately sent so callers can override a previously persisted fast
 * tier in Codex/ChatGPT-style runtimes.
 */
...
export interface Model<TApi extends Api = any> {
	 ...
	 *
	 * Used by containerized gjc installs (e.g. robojwc slots) to route every
