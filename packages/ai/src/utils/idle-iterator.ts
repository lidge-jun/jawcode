 ...
 *
 * `fallbackMs` widens the floor for transports whose legitimate silent gaps
 * exceed the global default (e.g. Codex reasoning models); env overrides and
 * caller options still take precedence.
 */
