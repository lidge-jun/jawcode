...
const CLIENT_ID = $env.GOOGLE_ANTIGRAVITY_CLIENT_ID;
const CLIENT_SECRET = $env.GOOGLE_ANTIGRAVITY_CLIENT_SECRET;
...
function requireOAuthConfig(): { clientId: string; clientSecret: string } {
	if (!CLIENT_ID || !CLIENT_SECRET) {
		throw new Error("Antigravity OAuth requires GOOGLE_ANTIGRAVITY_CLIENT_ID and GOOGLE_ANTIGRAVITY_CLIENT_SECRET.");
	}
