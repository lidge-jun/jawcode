...
const CLIENT_ID = $env.GOOGLE_GEMINI_CLI_CLIENT_ID;
const CLIENT_SECRET = $env.GOOGLE_GEMINI_CLI_CLIENT_SECRET;
...
function requireOAuthConfig(): { clientId: string; clientSecret: string } {
	if (!CLIENT_ID || !CLIENT_SECRET) {
		throw new Error("Gemini CLI OAuth requires GOOGLE_GEMINI_CLI_CLIENT_ID and GOOGLE_GEMINI_CLI_CLIENT_SECRET.");
	}
