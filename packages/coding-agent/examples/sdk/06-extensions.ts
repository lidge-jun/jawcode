 ...
 * - ~/.jwc/agent/extensions/ (legacy: ~/.pi/agent/extensions/)
 * - <cwd>/.jwc/extensions/ (legacy: <cwd>/.pi/extensions/)
...
//   1. Place extension files in ~/.jwc/agent/extensions/ or .jwc/extensions/
