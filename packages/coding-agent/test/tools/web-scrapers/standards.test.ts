...
import { handleCheatSh } from "@jawcode-dev/coding-agent/web/scrapers/cheatsh";
import { handleRfc } from "@jawcode-dev/coding-agent/web/scrapers/rfc";
import { handleTldr } from "@jawcode-dev/coding-agent/web/scrapers/tldr";
