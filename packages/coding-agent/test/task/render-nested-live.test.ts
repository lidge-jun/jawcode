...
import type { AgentProgress, TaskResultReceipt, TaskToolDetails } from "@jawcode-dev/coding-agent/task";
import { taskToolRenderer } from "@jawcode-dev/coding-agent/task/render";
