...
import { clearCache, readFile } from "@jawcode-dev/coding-agent/capability/fs";
...
import { getProjectPathCandidates } from "@jawcode-dev/coding-agent/discovery/agents";
import {
...
describe("agents provider project-level discovery", () => {
	...
	describe("skills", () => {
		...
		test("project walk-up skips home directory (no repo root)", async () => {
			// Regression for https://github.com/lidge-jun/jawcode/issues/1116:
