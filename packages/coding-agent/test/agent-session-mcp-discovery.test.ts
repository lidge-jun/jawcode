...
describe("AgentSession MCP discovery", () => {
	...
	it("fast off persists an explicit default service tier", () => {
		...
		expect(settings.get("serviceTier")).toBe("default");
		expect(sessionManager.buildSessionContext().serviceTier).toBe("default");
