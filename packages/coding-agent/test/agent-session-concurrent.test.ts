...
import { Agent, AgentBusyError, type AgentTool } from "@jawcode-dev/agent-core";
import { type AssistantMessage, getBundledModel, type Message, type ToolCall } from "@jawcode-dev/ai";
...
import { TtsrManager } from "@jawcode-dev/coding-agent/export/ttsr";
...
describe("AgentSession concurrent prompt guard", () => {
	...
	// already processing` from jwc-rpc clients (robojwc triage reminder path).
