...
import type { MarketplacePluginEntry } from "@jawcode-dev/coding-agent/extensibility/plugins/marketplace";
import { resolvePluginSource } from "@jawcode-dev/coding-agent/extensibility/plugins/marketplace";
