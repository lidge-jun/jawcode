...
export interface JwcLaunchWorktreeResult extends JwcLaunchWorktreePlan {
	created: boolean;
	reused: boolean;
...
export function parseLaunchWorktreeMode(args: string[]): ParsedLaunchWorktreeMode {
	let mode: JwcLaunchWorktreeMode = { enabled: false };
...
export function planLaunchWorktree(
	cwd: string,
	mode: JwcLaunchWorktreeMode,
): JwcLaunchWorktreePlan | { enabled: false } {
...
export function ensureLaunchWorktree(
	plan: JwcLaunchWorktreePlan | { enabled: false },
): JwcLaunchWorktreeResult | { enabled: false } {
...
export function prepareLaunchWorktree(
	...
	cwd: string;
	args: string[];
	worktree: JwcLaunchWorktreeResult | { enabled: false };
} {
