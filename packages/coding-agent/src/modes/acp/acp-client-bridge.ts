...
const ACP_PERMISSION_MODE_ENV = "JWC_ACP_PERMISSION_MODE";
...
function resolveAcpPermissionMode(clientCapabilities: ClientCapabilities | undefined): AcpPermissionMode {
	...
	if (typeof meta === "object" && meta !== null) {
		const jwc = (meta as { jwc?: unknown }).jwc;
		if (typeof jwc === "object" && jwc !== null && "permissionHandling" in jwc) {
			return parseAcpPermissionMode((jwc as { permissionHandling?: unknown }).permissionHandling);
		}
	}
