...
export const SETTINGS_SCHEMA = {
	...
	"compaction.thresholdPercent": {
		...
		ui: {
			...
			description:
				"Percent threshold for context maintenance; set to Reserve-based to use legacy reserve-based behavior",
			options: [
				{ value: "default", label: "Reserve-based", description: "Legacy reserve-based threshold" },
				...
				{ value: "73", label: "73%", description: "Default threshold" },
				{ value: "75", label: "75%", description: "Slightly aggressive" },
				{ value: "77", label: "77%", description: "Moderately aggressive" },
