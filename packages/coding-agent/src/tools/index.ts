...
export interface ToolSession {
	...
	/** Register a cleanup callback owned by this session. Called during AgentSession.dispose(). */
 ...
 * PI-optimized: enough for any model to code without discovery.
 * search_tool_bm25 is auto-created when discoveryMode !== "off" (separate path). */
