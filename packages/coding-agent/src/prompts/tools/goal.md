...
- `pause` suspends the active goal and stops continuation steers. Use when all deliverables are done but programmatic completion is blocked, or when the user should decide the next step.
