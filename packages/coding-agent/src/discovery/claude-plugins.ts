...
import { rootContainsJwcManifest } from "../extensibility/jwc-plugins";
import {
...
async function listNonJwcPluginRoots(
	home: string,
	cwd: string,
...
async function loadSkills(ctx: LoadContext): Promise<LoadResult<Skill>> {
	...
	const { roots, warnings: rootWarnings } = await listNonJwcPluginRoots(ctx.home, ctx.cwd);
