...
import type { CompactionPreparation, CompactionResult } from "@jawcode-dev/agent-core/compaction";
import type { ImageContent, TextContent, ToolResultMessage } from "@jawcode-dev/ai";
