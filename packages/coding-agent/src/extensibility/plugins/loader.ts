...
import { getPluginsLockfile, getPluginsNodeModules, getPluginsPackageJson, isEnoent } from "@jawcode-dev/utils";
...
/**
 * Load project-local plugin overrides (checks .jwc and .pi directories).
 */
