"""Client half of the robojwc ↔ gh-proxy channel.
...
routing clone/fetch/push through the proxy too — robojwc never holds the PAT.
...
from robojwc.git_ops import GitCommandError, HeadDriftError, PushResult
...
class GitHubProxyClient:
    """HMAC-signed REST client speaking to a `robojwc.proxy.server` instance.
